...
exports.DeleteImageParamsDto = void 0;
const nestjs_zod_1 = require("nestjs-zod");
const zod_1 = require("zod");
const DeleteImageParamsSchema = zod_1.z.object({
    fileName: zod_1.z
        .string()
...
class DeleteImageParamsDto extends (0, nestjs_zod_1.createZodDto)(DeleteImageParamsSchema) {
}
exports.DeleteImageParamsDto = DeleteImageParamsDto;
